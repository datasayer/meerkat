 ...
 * SignalMeer - The signal meerkat is a real-time result storage and serves as a signalman.  You can create your own storage by implementing SignalMeerInterface, e.g., DBSignalMeer, MemcachedSignalMeer, ..., etc.
